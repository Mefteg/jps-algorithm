...
Utils.Coord = function(_x, _y)
{
    ...
    this.distance = function(_other)
    {
        var deltaX = this.x - _other.x;
        var deltaY = this.y - _other.y;
...
Utils.Node = function(_coord, _cost, _parent)
{
    this.parent = _parent;
    this.coord = _coord;
    this.cost = _cost;
